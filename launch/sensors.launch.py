...
def generate_launch_description():
    laser_sensor_name = "zed2"
    depth_sensor_name = "zed2"
    ...
    depth_topics = {
        ...
        'zed2': ['/zed/top/depth/depth_registered', '/zed/top/depth/camera_info'],
    ...
    point_cloud_topics = {
        ...
        'zed2': '/zed/top/point_cloud/cloud_registered',
    ...
    laser_launch_path = PathJoinSubstitution(
        [FindPackageShare('shimmy_bot'), 'launch', 'lasers.launch.py']
    )

    depth_launch_path = PathJoinSubstitution(
        [FindPackageShare('shimmy_bot'), 'launch', 'depth.launch.py']
    )
